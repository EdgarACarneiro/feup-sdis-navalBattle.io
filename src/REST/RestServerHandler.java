...
public class RestServerHandler implements HttpHandler {
	...
	public void handle(HttpExchange t) throws IOException {
		...
		switch (paths[2]) {
		case "attack":
			//chama função relativa ao url no rest_api com os parâmetros obtidos anteriormente
			//o retorno da função do rest_api pode ser a resposta ao "pedido" nesse caso chamar sendResponse(HttpExchange t, int statusCode, String response)
			break;
		default:
